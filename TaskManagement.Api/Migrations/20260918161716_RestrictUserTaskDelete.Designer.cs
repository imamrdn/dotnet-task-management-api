...
namespace TaskManagement.Api.Migrations
{
    ...
    [Migration("20260918161716_RestrictUserTaskDelete")]
    partial class RestrictUserTaskDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Api.Models.TaskCategory", b =>
                {
            ...
            modelBuilder.Entity("TaskManagement.Api.Models.TaskItem", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsDeleted", "Id");
            ...
            modelBuilder.Entity("TaskManagement.Api.Models.UserProfile", b =>
                {
                    b.HasOne("TaskManagement.Api.Models.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("TaskManagement.Api.Models.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
